...
- "task" : "code" (programmation, dev, web, refactor), "agentic" (agents, outils, automatisation, tool calling), "redaction" (rédiger dans une autre langue que le français, ou langue non précisée : article, blog, SEO, GEO, newsletter, page web, post social, copywriting), "redaction_fr" (rédiger en français, ou question posée pour du contenu francophone), "documents" (résumer ou analyser des documents longs, PDF, transcriptions, audits), "general" (chat, questions-réponses, traduction, tout le reste).
